...
import com.example.proyecto_final_pmdm_daniel_carmona_salazar.Clases.VentaRecyclerView.ListaVentasAdapter;
...
public class MostrarInfoVentaActivity extends AppCompatActivity {

    private RecyclerView rvVentas;
    private ArrayList<Venta> ventas;
    private ListaVentasAdapter listaVentasAdapter = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mostrar_info_venta);
