...
public class EmpleadosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        totalRegistros = EmpleadoController.obtenerCantidadEmpleados();
        ...
        if (empleados != null) {
            ...
            Log.i("SQL", "EMPLEADOS LEÍDOS -> " + String.valueOf(this.empleados.size()));
            rvEmpleados = vista.findViewById(R.id.rvEmpleados);
            listaEmpleadosAdapter = new ListaEmpleadosAdapter(getContext(), empleados);
            rvEmpleados.setAdapter(listaEmpleadosAdapter);
            int orientation = 1;
            if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                rvEmpleados.setLayoutManager(new LinearLayoutManager(getActivity()));
            } else {
            ...
            rvEmpleados.addOnScrollListener(new PaginationListener((LinearLayoutManager) rvEmpleados.getLayoutManager()) {
                ...
                protected void loadMoreItems() {
                    ...
                    if (totalRegistrosLeídos < totalRegistros) {
                        ...
                        Log.i("SQL", "EMPLEADOS LEÍDOS -> " + String.valueOf(this.empleadosLeídos));
                    }else{
                        empleadosLeídos = 0;
                    }
                }
